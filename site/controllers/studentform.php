...
class SchoolControllerStudentForm extends SchoolController {
    ...
    public function edit() {
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_school&view=student&layout=edit', false));
    }
    ...
    public function save() {
        ...
        if ($data === false) {
            ...
            $app->setUserState('com_school.edit.student.data', $jform, array());

            // Redirect back to the edit screen.
            $id = (int) $app->getUserState('com_school.edit.student.id');
            $this->setRedirect(JRoute::_('index.php?option=com_school&view=studentform&layout=edit&id=' . $id, false));
            return false;
        }
    ...
    public function remove() {
        ...
        if ($data === false) {
            ...
            // Redirect back to the edit screen.
            $id = (int) $app->getUserState('com_school.edit.student.id');
            $this->setRedirect(JRoute::_('index.php?option=com_school&view=student&layout=edit&id=' . $id, false));
            return false;
        }
